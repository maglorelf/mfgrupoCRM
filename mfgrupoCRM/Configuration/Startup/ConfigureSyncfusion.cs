...
namespace mfgrupoCRM.Configuration.Startup
{
    ...
    {
        public static IServiceCollection ConfigureSyncfusion(this IServiceCollection services, IConfiguration config)
        {
            //Register Syncfusion license
            Syncfusion.Licensing.SyncfusionLicenseProvider.RegisterLicense(config["SyncfusionLicense"]);
        ...
        public static IApplicationBuilder ConfigureSyncfusion(this IApplicationBuilder app)
        {
